        ...
        <div class="row m-0 text-center">
          ...
          do{ ?>
            <div class="list-group col-md-4 mb-3">
              <a href="index.php?page=confirmstockdelete&id=<?php echo $st_rs['id']?>" class="list-group-item list-group-item-action flex-column align-items-start">
